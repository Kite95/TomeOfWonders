...
public class ForgeEvents {
    ...
    private static final AttributeModifier WHIRLICAP_GRAVITY = new AttributeModifier(WHIRLICAP_MODIFIER, "whirlicap gravity modifier", -0.02D, AttributeModifier.Operation.ADDITION);
