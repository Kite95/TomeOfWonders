...
public class TomeArmorMaterial {

    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(Registries.ARMOR_MATERIAL, TomeOfWonders.MOD_ID);
    ...
    public TomeArmorMaterial(String name, int durability, int[] damageReduction, int enchantability, Holder<SoundEvent> sound, float toughness) {
        this.name = name;
    ...
    public TomeArmorMaterial(String name, int durability, int[] damageReduction, int enchantability, Holder<SoundEvent> sound, float toughness, float knockbackResist) {
        this.name = name;
        this.durability = durability;
        this.damageReduction = damageReduction;
        this.enchantability = enchantability;
    ...
    private void registerMaterial() {
        this.holder = ARMOR_MATERIALS.register(this.name, () -> {
            ...
            return new ArmorMaterial(
                    ...
                    this.sound,
                    this.ingredient,
                    List.of(new ArmorMaterial.Layer(TomeOfWonders.modPrefix(this.name))),
                    this.toughness,
